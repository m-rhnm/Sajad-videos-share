...
<div class="container">
    <div class="bread-crumb flex-w p-t-30">
        <a href="{{ route('home.videos.all') }}" class="mtext-106 cl8 hov-cl1 trans-04">
            خانه
                        ...
                        <div class="slick3 gallery-lb">
                            <div class="item-slick3" >
                                ...
                                <video controls style="height: 100%; width: 100%;">
                                    <source
                                        src="{{ Storage::url($videos->demo_url) }}"
                                        type="video/mp4">
                                </video>
                                </div>
                            </div>
...
<section class="sec-relate-product bg0 p-t-45 p-b-105">
    <div class="container">
        ...
        <div class="wrap-slick2">
            <div class="slick2">
                @foreach($simillerVideos as $simillerVideo)
                    <div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
                        <!-- Block2 -->
                        <div class="block2">
                            <div class="block2-pic hov-img0">
                                <img src="{{ Storage::url($simillerVideo->thumbnail_url)}}" alt="IMG-PRODUCT">
                            ...
                            <div class="block2-txt flex-w flex-t p-t-14">
                                <div class="block2-txt-child1 flex-col-l ">
                                    <a href="{{ route('home.videos.show',$simillerVideo->id) }}" class="mtext-106 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                        {{ $simillerVideo->title }}
                                    </a>

                                    <span class="stext-105 cl3">
                                    {{ $simillerVideo->price }} هزار تومان
                                    </span>
                                </div>
                            </div>
                        </div>
